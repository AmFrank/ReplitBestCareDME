...
export class MemStorage implements IStorage {
  ...
  async createSubmission(submission: InsertContactSubmission): Promise<ContactSubmission> {
    ...
    const contactSubmission: ContactSubmission = { 
      ...
      injuryType: submission.injuryType || null,
      affectedExtremity: submission.affectedExtremity || null,
      injuryYear: submission.injuryYear || null,
      currentTherapy: submission.currentTherapy || null,
      referralSource: submission.referralSource || null,
